# Aug 2023
# trainer code for cross-attention computation
# Combined with main_CI_1.py and main_CI_0.py
...
def train(data, epochs, x_values, y_values): 
    ...
    for epoch in range(epochs):
        ...
        for idx, (in_seq, target) in enumerate(train_loader):
            optimizer.zero_grad()
            input_x = in_seq[:,:,0] # the (x,z) order is declared in the main function
            input_z = in_seq[:,:,1]
